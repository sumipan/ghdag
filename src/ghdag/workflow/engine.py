...
from ghdag.llm.spec import ENGINE_SPECS, EngineSpec, render_exec_command, render_exec_line
...
def get_adapter(name: str) -> EngineAdapter:
    ...
    raise ValueError(f"Unknown engine: {name!r}. Available: {sorted(ENGINE_SPECS)}")
