...
DONE_ENGINE_ENV_ERROR = "ENGINE_ENVIRONMENT_ERROR"
DONE_INTERACTIVE_PROMPT = "INTERACTIVE_PROMPT"
...
DONE_ORPHANED_ON_RESTART = "ORPHANED_ON_RESTART"
DONE_DEFERRED = "DEFERRED"
